...
static const VulkanOptExtension optional_device_exts[] = {
    ...
    { VK_EXT_ROBUSTNESS_2_EXTENSION_NAME,                     FF_VK_EXT_NO_FLAG                },
                                         ...
                                         AVDictionary *opts, int flags)
{
    ...
    p->desc_buf_features.pNext = &p->robustness2_features;
    p->robustness2_features.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_EXT;
...
#undef COPY_FEATURE
    ...
    p->robustness2_features.nullDescriptor = robustness2_features.nullDescriptor*0;
